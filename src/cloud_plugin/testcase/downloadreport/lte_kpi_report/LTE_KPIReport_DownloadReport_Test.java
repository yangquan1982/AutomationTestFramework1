package cloud_plugin.testcase.downloadreport.lte_kpi_report;
...
public class LTE_KPIReport_DownloadReport_Test {
	...
	// Data path
	private static String ParaFile = ConstUrl.getProjectHomePath() + "\\Data\\稳定性测试\\用户报告下载\\LTE KPI报告\\LTE KPI报告.xlsx";

	public LTE_KPIReport_DownloadReport_Test(String secns, String taskName) {
		this.secns = secns;
	...
	public void downLoad_report() {
		...
		LTEKPIReportTask.downLoad_report(driver, defaultWindowID, taskName);
	}
}
