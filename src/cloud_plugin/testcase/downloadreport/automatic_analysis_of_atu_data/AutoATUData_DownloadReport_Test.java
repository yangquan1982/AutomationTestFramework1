package cloud_plugin.testcase.downloadreport.automatic_analysis_of_atu_data;
...
public class AutoATUData_DownloadReport_Test {
	@Rule
	...
	private static String ParaFile = ConstUrl.getProjectHomePath()
			+ "\\Data\\稳定性测试\\用户报告下载\\ATU数据自动分析\\ATU数据自动分析.xlsx";

	public AutoATUData_DownloadReport_Test(String secns,
			String taskName) {
		this.secns = secns;
	...
	public void downLoad_report() {
		...
		AutoATUDataTask.downLoad_report(driver, defaultWindowID,
				taskName);
