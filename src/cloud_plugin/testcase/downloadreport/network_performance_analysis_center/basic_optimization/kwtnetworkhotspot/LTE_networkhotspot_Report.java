package cloud_plugin.testcase.downloadreport.network_performance_analysis_center.basic_optimization.kwtnetworkhotspot;
...
public class LTE_networkhotspot_Report {
	@Rule
	...
	private static String ResultHome = ConstUrl.getProjectHomePath()+"\\Data\\result\\LTE_价值区域评估\\";
	private static String BaselineHome = ConstUrl.getProjectHomePath()+"\\Data\\baseline\\LTE_价值区域评估\\";
	...
	private static String ParaFile = FilePath+"\\LTE价值区域评估参数化表\\LTE价值区域评估参数化表.xlsx";
	private static String GT3KFile = FilePath + "\\GT3K.ini";
	
	public LTE_networkhotspot_Report(String secns,String taskName,String TestCaseId){
		this.secns = secns;
	...
	@Test(GT3Kid = "")
	public void T001_networkhotspot() {
		...
		HotSpotTask.downLoad_report(driver, defaultWindowID, taskName, ResultHome1);
