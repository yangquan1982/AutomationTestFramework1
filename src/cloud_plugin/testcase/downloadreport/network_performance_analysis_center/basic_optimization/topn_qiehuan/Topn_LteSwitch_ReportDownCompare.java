package cloud_plugin.testcase.downloadreport.network_performance_analysis_center.basic_optimization.topn_qiehuan;
...
public class Topn_LteSwitch_ReportDownCompare {
	...
	private static String ResultHome = ConstUrl.getProjectHomePath() + "\\Data\\result\\TOPN_切换\\";
	private static String BaselineHome = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\TOPN_切换\\";
	...
	// Data path
	private static String FilePath = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\TOPN_切换";
	private static String ParaFile = FilePath + "\\参数化表\\LTETopn小区处理报告对比参数化表切换.xlsx";
	...
	public void L_TopSwitch_Report() {
		...
		Topncellprocessing.Switch_downLoad_report(driver, defaultWindowID, taskName, ResultHome1);
