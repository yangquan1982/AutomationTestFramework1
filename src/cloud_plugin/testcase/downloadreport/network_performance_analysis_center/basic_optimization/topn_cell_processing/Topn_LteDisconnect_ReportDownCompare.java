...
public class Topn_LteDisconnect_ReportDownCompare {
	@Rule
	...
	public Topn_LteDisconnect_ReportDownCompare(String secns, String taskName, String TestCaseId) {
		this.secns = secns;
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(ParamUtil.getObjectArr(ParaFile, "TOPN掉话"));
	}
	...
	@Test(GT3Kid = "")
	public void L_TopnDisconnect_Report() {
		...
		Topncellprocessing.Disconnect_downLoad_report(driver, defaultWindowID, taskName, ResultHome1);
