...
public class Topn_LteThroughtOut_ReportDownCompare {
	@Rule
	...
	private static String ResultHome = ConstUrl.getProjectHomePath() + "\\Data\\result\\LTE_Topn小区处理\\";
	private static String BaselineHome = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\LTE_Topn小区处理\\";
	...
	public Topn_LteThroughtOut_ReportDownCompare(String secns, String taskName, String TestCaseId) {
		this.secns = secns;
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(ParamUtil.getObjectArr(ParaFile, "TOPN吞吐率"));
	}
	...
	@Test(GT3Kid = "")
	public void L_TopnThroughtOut_Report() {
		...
		Topncellprocessing.ThroughputRate_downLoad_report(driver, defaultWindowID, taskName, ResultHome1);
