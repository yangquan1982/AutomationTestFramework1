...
public class Topn_LteAccess_ReportDownCompare {
	@Rule
	...
	public Topn_LteAccess_ReportDownCompare(String secns, String taskName, String TestCaseId) {
		this.secns = secns;
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(ParamUtil.getObjectArr(ParaFile, "TOPN接入"));
	}
	...
	@Test(GT3Kid = "")
	public void L_TopnLteAccess_Report() {
		...
		Topncellprocessing.Access_downLoad_report(driver, defaultWindowID, taskName, ResultHome1);
