package cloud_plugin.testcase.downloadreport.network_performance_analysis_center.basic_optimization.kwtcoverevaluate;
...
public class LTE_CoverEvaluate_Report {
	@Rule
	...
	private static String ResultHome = ConstUrl.getProjectHomePath() + "\\Data\\result\\LTE_覆盖评估\\";
	private static String BaselineHome = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\LTE_覆盖评估\\";

	private String secns;
	private String taskName;

	// Data path
	private static String FilePath = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\LTE_覆盖评估";
	private static String ParaFile = FilePath + "\\LTE覆盖评估参数化表\\LTE覆盖评估参数化表.xlsx";

	public LTE_CoverEvaluate_Report(String secns, String taskName) {
		this.secns = secns;
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(ParamUtil.getObjectArr(ParaFile, "LTE", 0));
	}
	...
	public void T001_CoverEvaluate() {
		...
		NetworkAnalysisCenterTask.openLTEContentEvaluate(driver);
