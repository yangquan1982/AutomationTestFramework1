...
public class LTE_HuiliuCompare_Report {
	@Rule
	...
	private static String ParaFile = FilePath + "\\业务与话务预测参数化表\\业务与话务预测回流.xlsx";
	private static String GT3KFile = FilePath + "\\GT3K.ini";

	public LTE_HuiliuCompare_Report(String secns, String taskName, String TestCaseId) {
		this.secns = secns;
	...
	@Test(GT3Kid = "")
	public void L_HuiliuCompare_Report() {
		...
		Assert.assertTrue(CommonFile.fileReportMsg(ResultHome1), FileCompare.fileCompare(BaselineHome1, ResultHome1,
				new String[] { "3G_Cell", "3G-4G", "4G_Cell", "Network" }));
