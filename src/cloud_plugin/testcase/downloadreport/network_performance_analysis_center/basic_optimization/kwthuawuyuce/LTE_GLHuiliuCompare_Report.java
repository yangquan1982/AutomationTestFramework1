...
public class LTE_GLHuiliuCompare_Report {
	@Rule
	...
	private static String ParaFile = FilePath + "\\业务与话务预测参数化表\\业务与话务预测GL回流.xlsx";
	private static String GT3KFile = FilePath + "\\GT3K.ini";

	public LTE_GLHuiliuCompare_Report(String secns, String taskName, String TestCaseId) {
		this.secns = secns;
	...
	public void L_GLHuiliuCompare_Report() {
		...
		Assert.assertTrue(CommonFile.fileReportMsg(ResultHome1), FileCompare.fileCompare(BaselineHome1, ResultHome1,
				new String[] { "2G_Cell", "2G-4G", "4G_Cell", "Network" }));
