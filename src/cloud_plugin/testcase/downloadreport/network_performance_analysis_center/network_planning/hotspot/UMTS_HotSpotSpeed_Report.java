package cloud_plugin.testcase.downloadreport.network_performance_analysis_center.network_planning.hotspot;
...
public class UMTS_HotSpotSpeed_Report {
	@Rule
	...
	private static String ResultHome = ConstUrl.getProjectHomePath() + "\\Data\\result\\U_速率评估\\";
	private static String BaselineHome = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\U_速率评估\\";
	...
	private static String ParaFile = FilePath + "\\参数化表\\报告下载参数化表速率.xlsx";
	private static String GT3KFile = FilePath + "\\GT3K.ini";

	public UMTS_HotSpotSpeed_Report(String secns, String TestCaseId, String taskName) {
		this.secns = secns;
