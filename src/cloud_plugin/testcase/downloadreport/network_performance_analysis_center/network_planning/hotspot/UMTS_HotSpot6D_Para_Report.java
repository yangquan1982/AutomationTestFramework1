...
public class UMTS_HotSpot6D_Para_Report {
	...
	private static String ResultHome = ConstUrl.getProjectHomePath() + "\\Data\\result\\U_6D评估\\";
	private static String BaselineHome = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\U_6D评估\\";
	...
	private static String ParaFile = FilePath + "\\参数化表\\报告下载参数化表6D.xlsx";
	private static String GT3KFile = FilePath + "\\GT3K.ini";

	public UMTS_HotSpot6D_Para_Report(String secns, String TestCaseId, String taskName) {
		this.secns = secns;
