package cloud_plugin.testcase.downloadreport.network_performance_analysis_center.network_planning.dt_overseas;
...
public class LTE_DTOverseas_Report {
	...
	private static String ResultHome = ConstUrl.getProjectHomePath() + "\\Data\\result\\LTE_DT海外\\";
	private static String BaselineHome = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\LTE_DT海外\\";
	...
	private static String ParaFile = FilePath + "\\参数化表\\DT报告下载.xlsx";
	private static String GT3KFile = FilePath + "\\GT3K.ini";

	public LTE_DTOverseas_Report(String secns, String TestCaseId, String taskName) {
		this.secns = secns;
	...
	public void L_PCIOptimization() {
		...
		AutoDTDataOverseasTask.downLoad_MoveReport(driver, defaultWindowID, taskName, ResultHome1);
