package cloud_plugin.testcase.downloadreport.network_performance_analysis_center.network_planning.content_evaluate;
...
public class UMTS_ContentEvaluate_Report {
	@Rule
	...
	private static String ParaFile = FilePath + "\\参数化表\\报告下载参数化表ContentEvaluate.xlsx";
	private static String GT3KFile = FilePath + "\\GT3K.ini";

	public UMTS_ContentEvaluate_Report(String secns, String TestCaseId, String taskName, String[] StartWith) {
		this.secns = secns;
