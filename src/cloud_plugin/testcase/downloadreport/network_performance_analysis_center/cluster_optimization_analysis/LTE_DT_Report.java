package cloud_plugin.testcase.downloadreport.network_performance_analysis_center.cluster_optimization_analysis;
...
public class LTE_DT_Report {
	...
	private static String ResultHome = ConstUrl.getProjectHomePath() + "\\Data\\result\\簇优化分析\\";
	private static String BaselineHome = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\簇优化分析\\";
	...
	public LTE_DT_Report(String secns, String TestCaseId, String taskName, String[] StartWith) {
		this.secns = secns;
	...
	public void L_PCIOptimization() {
		...
		ClusterOptimizationTask.downLoad_MoveReport(driver, defaultWindowID, taskName, ResultHome1);
		if (StartWith == null) {
