package cloud_plugin.testcase.downloadreport.network_performance_analysis_center.pci_optimization;
...
public class LTE_PCIOptimization_Report {
	...
	private static String ResultHome = ConstUrl.getProjectHomePath() + "\\Data\\result\\PCI优化\\";
	private static String BaselineHome = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\PCI优化\\";
	...
	private static String ParaFile = FilePath + "\\参数化表\\PCI优化报告下载.xlsx";
	private static String GT3KFile = FilePath + "\\GT3K.ini";

	public LTE_PCIOptimization_Report(String secns, String TestCaseId, String taskName, String[] StartWith) {
		this.secns = secns;
	...
	public void L_PCIOptimization() {
		...
		PCIOptimizationTask.downLoad_MoveReport(driver, defaultWindowID, taskName, ResultHome1);
