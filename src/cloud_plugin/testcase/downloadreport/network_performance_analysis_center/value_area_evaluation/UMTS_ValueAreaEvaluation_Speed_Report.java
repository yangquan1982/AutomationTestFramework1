package cloud_plugin.testcase.downloadreport.network_performance_analysis_center.value_area_evaluation;
...
public class UMTS_ValueAreaEvaluation_Speed_Report {
	...
	private static String ParaFile = FilePath + "\\参数化表\\Smoke报告下载参数化表速率.xlsx";

	public UMTS_ValueAreaEvaluation_Speed_Report(String secns, String taskName) {
		this.secns = secns;
