package cloud_plugin.testcase.downloadreport.network_performance_analysis_center.automatic_analysis_of_dt_data;
...
public class LTE_DT_Report {
	...
	private static String ResultHome = ConstUrl.getProjectHomePath() + "\\Data\\result\\DT数据自动分析\\";
	private static String BaselineHome = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\DT数据自动分析\\";
	...
	public void L_PCIOptimization() {
		...
		AutoDTDataTask.downLoad_MoveReport(driver, defaultWindowID, taskName, ResultHome1);
		if (StartWith == null) {
