...
public class PoorQualityThresholdIdentification_Report {
	...
	private static String FilePath = ConstUrl.getProjectHomePath()
			+ "\\Data\\baseline\\视频优化质差门限识别\\参数化表\\视频优化质差门限识别报告下载.xlsx";
	private static String GT3KFile = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\视频优化质差门限识别\\GT3K.ini";

	public PoorQualityThresholdIdentification_Report(String secns, String TestCaseId, String taskName, String[] Folder,
			String StartWith) {
		this.secns = secns;
	...
	public void test() {
		...
		if (StartWith != null) {
			PoorQualityThresholdIdentificationTask.downLoad_MoveReport(driver, defaultWindowID, taskName, ResultHome1);
