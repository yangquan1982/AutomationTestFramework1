...
public class BenchmarkOptimization_Report {
	...
	private static String ResultHome = ConstUrl.getProjectHomePath() + "\\Data\\result\\排名提升优化\\报告\\";
	private static String BaselineHome = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\排名提升优化\\报告\\";
	private String secns;
	private String TestCaseId;
	private String taskName;
	private String[] Folder;
	private String StartWith;
	private static String FilePath = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\排名提升优化\\参数化表\\排名提升优化报告下载.xlsx";
	private static String GT3KFile = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\排名提升优化\\GT3K.ini";

	public BenchmarkOptimization_Report(String secns, String TestCaseId, String taskName, String[] Folder,
			String StartWith) {
		this.secns = secns;
