...
public class LTE_KPIReport_UnicomReport {
	...
	private static String ServiceType = "LTE KPI Report";
	...
	public LTE_KPIReport_UnicomReport(String secns, String TestCaseId, String taskName001, String[] Datafile) {
		this.secns = secns;
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(ParamUtil.getObjectArr(ParaFile, "联通"));
	}
	...
	@Test(GT3Kid = "")
	public void L_UnicomReport() {
		LOG.info_testcase("场景描述:" + secns);

		System.out.println(ZIP.NowTime() + "Start the testcase:" + name.getMethodName());
		String taskName = LTEKPIReportTask.creatKPIReportUnicomTask(driver, defaultWindowID, taskName001, Datafile);
