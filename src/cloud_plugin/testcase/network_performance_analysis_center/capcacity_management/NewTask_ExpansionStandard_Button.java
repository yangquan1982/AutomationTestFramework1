...
public class NewTask_ExpansionStandard_Button {
	...
	public NewTask_ExpansionStandard_Button(String secns,  String taskLanguage , String[] cfgDate, String[] mmlDate, String[] prsDate,
	...
	public static Collection<Object[]> data() throws Exception {
		...
		Object[][] firstParam = new Object[1][17];
		for (int i = 0; i < 17; i++) {
			firstParam[0][i] = param[0][i];
		}
		return Arrays.asList(firstParam);
	}
	...
	@Test(GT3Kid = "")
	public void T001_NewTask_ExpansionStandard_Button() {
		System.out.println(secns);
		CapcacityManagementTask.createNewTaskSetting(driver, secns, taskLanguage,defaultWindowID, cfgDate, mmlDate, prsDate,
				prsDateModel, u2000Date, u2000DateModel, enodbeFilePath);
	
		CapcacityManagementTask.clickALLESButton(driver);
