package cloud_plugin.testcase.network_performance_analysis_center.coverage_evaluation;
...
public class UMTS_CoverageEvaluation_Report {
	...
	private static String ParaFile = FilePath + "\\参数化表\\SmokeCoverageEvaluation.xlsx";
	...
	public UMTS_CoverageEvaluation_Report(String secns, String taskName001, String[] cfgFile, String[] EparaFile,
			String[] MrFile, String[] FeatureFile, String[] MapFile, String PositType, String RasterValue,
			boolean AGPSFlage, String RasterMR, String RasterCellMR, String ECIO, String RSCP, boolean FilterCellFlage,
			String MainCell, String IndoorCoverRate, String ComplexCoverRate, String IndoorCoverLevel,
			String ComplexCoverLevel, boolean MrClearFlage, boolean AcpFlage) {
		this.secns = secns;
