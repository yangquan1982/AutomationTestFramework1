...
public class LTE_DLCoMPClusterDesign_HelpTest {
	...
	private static String ParaFile = FilePath + "\\参数化表\\L_特性规划设计.xlsx";
	...
	public LTE_DLCoMPClusterDesign_HelpTest(String secns, String TestCaseId, String taskName001, String[] ServiceModule,
			String[] cfgFile, String[] paraFile, String[] sigFile, String[] pefFile, String[] chrFile,
			String[] FeatureFile, String cellFile, String CAType, String[] Band, String[] BandWidth,
	...
	public static Collection<Object[]> data() throws Exception {
		return Arrays.asList(ParamUtil.getObjectArr(ParaFile, "Help"));
	}
	...
	@Test(GT3Kid = "")
	public void L_DLCoMPCluster_Help() {
		LOG.info_testcase("场景描述:" + secns);
		String cellFile1 = null;
		if (cellFile != null) {
			cellFile1 = FilePath + cellFile;
		}
		String helpfile = FilePath + "\\CommonFile\\专家求助附件.zip";
		...
		TaskReportTask.asserTaskInitialState(driver, taskName, null);
		TaskViewPluginTask.expertHelp(driver, taskName, "远程交付任务", "远程交付任务,请处理", helpfile);
