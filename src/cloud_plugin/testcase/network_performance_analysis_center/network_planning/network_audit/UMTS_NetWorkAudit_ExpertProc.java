...
public class UMTS_NetWorkAudit_ExpertProc {
	@Rule
	...
	public UMTS_NetWorkAudit_ExpertProc(String secns, String TestCaseId, String taskName, boolean DownFlage,
			String fileName, String ProcType, String detailedDescription, String Filepath) {
		this.secns = secns;
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "专家处理"));
	}
	...
	public void U_ExpertProc() {
		...
		TaskViewPluginTask.expertProc(driver, taskName, DownFlage, fileName, ProcType, detailedDescription, helpfile);
