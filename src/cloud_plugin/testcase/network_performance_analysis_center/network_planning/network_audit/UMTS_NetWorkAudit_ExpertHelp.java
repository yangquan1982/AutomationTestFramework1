...
public class UMTS_NetWorkAudit_ExpertHelp {
	@Rule
	...
	public UMTS_NetWorkAudit_ExpertHelp(String secns, String TestCaseId, String taskName001, boolean ExcelFlage,
			...
			String[] NodeBLicensefile, String GrowthFactorFile, String HelpType, String detailedDescription,
			String Filepath) {
		this.secns = secns;
	...
	public static Collection<Object[]> data() throws Exception {
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "专家求助"));
	}
	...
	@Test(GT3Kid = "")
	public void U_ExpertHelp() {
		LOG.info_testcase("场景描述:" + secns);
		String ThresholdFile1 = null;
		if (ThresholdFile != null) {
			ThresholdFile1 = FilePath + "\\UMTS" + ThresholdFile;
		}
		String GrowthFactorFile1 = null;
		if (GrowthFactorFile != null) {
			GrowthFactorFile1 = FilePath + "\\UMTS" + GrowthFactorFile;
		}
