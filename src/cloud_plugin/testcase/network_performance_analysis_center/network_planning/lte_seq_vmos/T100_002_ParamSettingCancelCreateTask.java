...
public class T100_002_ParamSettingCancelCreateTask {
	...
	private static String SheetName = "参数设置取消操作验证";
	...
	public T100_002_ParamSettingCancelCreateTask(String secns, String testId, String projectName, String[] taskType,
	...
	public void T001_lte_seq_vmosCreateTask() {
		SeqVMOSTask.ParamSettingCancelCreateTask(driver, secns, ProjectName, TaskType, CfgData, ParamData, SigData,
				...
				LegendSetItem, LegendSetSegmentNumber, LegendSetValue);
		// 设置TMSS回填结果
		result = true;
	}
