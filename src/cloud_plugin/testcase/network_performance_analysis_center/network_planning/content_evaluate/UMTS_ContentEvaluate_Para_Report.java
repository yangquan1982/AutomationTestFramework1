...
public class UMTS_ContentEvaluate_Para_Report {
	@Rule
	...
	private static String ParaFile = FilePath + "\\参数化表\\ContentEvaluate.xlsx";
	...
	public UMTS_ContentEvaluate_Para_Report(String secns, String TestCaseId, String taskName001, String[] cfgFile,
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "BasicTraffic"));
	}
