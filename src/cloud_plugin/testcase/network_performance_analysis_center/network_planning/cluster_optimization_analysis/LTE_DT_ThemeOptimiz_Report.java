...
public class LTE_DT_ThemeOptimiz_Report {
	...
	public void L_ThemeOptimiz() {
		...
		String taskName = ClusterOptimizationTask.creatThemeOptimizTask(driver, defaultWindowID, taskName001, ThemeType,
				cfgfile, EParafile, DTfile, Mod3Para, OverCoverPara, GuoCoverPara, ZoomPara);
