...
public class UMTS_TrafficForecast_StarTermDev_Report {
	@Rule
	...
	private String TermForecast;
	private String PlanTermCount;
	...
	public UMTS_TrafficForecast_StarTermDev_Report(String secns, String TestCaseId, String taskName001,
			...
			String PredictionDate, String IndicType, boolean CalcFlage, String TerminalCompany, String TermForecast,
			String PlanTermCount, String TerminalA, String TerminalB) {
		this.secns = secns;
		...
		this.PlanTermCount = PlanTermCount;
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "StarTermDev"));
	}
	...
	public void U_BasicTraffic() {
		...
		String taskName = TrafficForecastTask.creatUMTSStarTermTask(driver, defaultWindowID, taskName001, groupFlage,
				groupType, groupFile1, cfgFile, pefFile, chrFile, pefU2000File, pefPRSFile, terminalFile1, HolidayFile,
				ModifyPara, PredictionDate, IndicType, TerminalCompany, TermForecast, PlanTermCount, TerminalA,
				TerminalB, Time, CalcFlage);
