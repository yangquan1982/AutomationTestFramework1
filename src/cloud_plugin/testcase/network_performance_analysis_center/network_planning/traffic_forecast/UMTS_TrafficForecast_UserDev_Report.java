...
public class UMTS_TrafficForecast_UserDev_Report {
	@Rule
	...
	private String MedialUser;
	private String LowUser;
	private static int Time = -1;// 不设置忙时
	private static String HolidayFile = FilePath + "\\CommonFile\\节假日补偿表.xlsx";

	public UMTS_TrafficForecast_UserDev_Report(String secns, String TestCaseId, String taskName001, boolean groupFlage,
			String groupType, String groupFile, String[] cfgFile, String[] pefFile, String[] chrFile,
			String[] pefU2000File, String[] pefPRSFile, String terminalFile, String ModifyPara, String PredictionDate,
			String IndicType, boolean CalcFlage, String UsersType, String UserPlan, String HistoryNum, String HighUser,
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "UserDev"));
	}
	...
	public void U_BasicTraffic() {
		...
		String taskName = TrafficForecastTask.creatUMTSUserDevTask(driver, defaultWindowID, taskName001, groupFlage,
				groupType, groupFile1, cfgFile, pefFile, chrFile, pefU2000File, pefPRSFile, terminalFile1, HolidayFile,
				ModifyPara, PredictionDate, IndicType, UsersType, UserPlan, HistoryNum, HighUser, MedialUser, LowUser,
				Time, CalcFlage);
