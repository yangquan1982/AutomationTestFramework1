...
public class UMTS_TrafficForecast_RibbonDev_Report {
	...
	private String Terminal3;
	private static int Time = -1;// 不设置忙时
	private static String HolidayFile = FilePath + "\\CommonFile\\节假日补偿表.xlsx";

	public UMTS_TrafficForecast_RibbonDev_Report(String secns, String TestCaseId, String taskName001,
			...
			String PredictionDate, String Terminal1, String Terminal2, String Terminal3) {
		this.secns = secns;
	...
	public static Collection<Object[]> data() throws Exception {
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "RibbonDev"));
	}
	...
	public void U_BasicTraffic() {
		...
		String taskName = TrafficForecastTask.creatUMTSRibbonDevTask(driver, defaultWindowID, taskName001, groupFlage,
				groupType, groupFile1, cfgFile, pefFile, chrFile, pefU2000File, pefPRSFile, terminalFile1, HolidayFile,
				ModifyPara, PredictionDate, Terminal1, Terminal2, Terminal3, Time);
