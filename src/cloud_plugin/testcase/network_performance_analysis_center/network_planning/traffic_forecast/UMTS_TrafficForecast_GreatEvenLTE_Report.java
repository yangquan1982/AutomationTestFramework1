...
public class UMTS_TrafficForecast_GreatEvenLTE_Report {
	...
	public UMTS_TrafficForecast_GreatEvenLTE_Report(String secns, String TestCaseId, String taskName001,
			...
			String PredictionDate, String HisTimeStart, String HisTimeEnd, String ModelStar, String ModelEnd,
			String SubStart, String SubEnd, String GroundCount, String TypeRatio, String MarketRatio) {
		this.secns = secns;
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "GreatEvenLTE"));
	}
	...
	public void U_BasicTraffic() {
		...
		String taskName = TrafficForecastTask.creatUMTSGreatEvenLTETask(driver, defaultWindowID, taskName001, groupType,
				groupFile1, cfgFile, pefFile, chrFile, pefU2000File, pefPRSFile, terminalFile1, HolidayFile, ModifyPara,
				PredictionDate, HisTimeStart, HisTimeEnd, ModelStar, ModelEnd, SubStart, SubEnd, GroundCount, TypeRatio,
				MarketRatio);
