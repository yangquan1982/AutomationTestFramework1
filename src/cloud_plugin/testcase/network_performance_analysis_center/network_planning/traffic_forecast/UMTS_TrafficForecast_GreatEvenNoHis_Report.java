...
public class UMTS_TrafficForecast_GreatEvenNoHis_Report {
	...
	private static String[] EvenIndicator = { "ALL" };
	private static String HolidayFile = FilePath + "\\CommonFile\\节假日补偿表.xlsx";

	public UMTS_TrafficForecast_GreatEvenNoHis_Report(String secns, String TestCaseId, String taskName001,
			...
			String PredictionDate, String GroundCount, String TypeRatio, String MarketRatio) {
		this.secns = secns;
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "GreatEvenNoHis"));
	}
	...
	public void U_BasicTraffic() {
		...
		String taskName = TrafficForecastTask.creatUMTSGreatEvenNoHisTask(driver, defaultWindowID, taskName001,
				groupFlage, groupType, groupFile1, cfgFile, pefFile, chrFile, pefU2000File, pefPRSFile, terminalFile1,
				HolidayFile, ModifyPara, PredictionDate, EvenIndicator, GroundCount, TypeRatio, MarketRatio);
