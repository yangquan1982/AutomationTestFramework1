...
public class UMTS_TrafficForecast_SuppreReduction_Report {
	@Rule
	...
	private String SuppreType;
	private String TcpUsage;
	private String DcmUser;
	private String HsdpaAve;
	private static String HolidayFile = FilePath + "\\CommonFile\\节假日补偿表.xlsx";

	public UMTS_TrafficForecast_SuppreReduction_Report(String secns, String TestCaseId, String taskName001,
			...
			String PredictionDate, String SuppreType, String TcpUsage, String DcmUser, String HsdpaAve) {
		this.secns = secns;
		...
		this.SuppreType = SuppreType;
		this.TcpUsage = TcpUsage;
		this.DcmUser = DcmUser;
		this.HsdpaAve = HsdpaAve;
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "SuppreReduction"));
	}
	...
	public void U_BasicTraffic() {
		...
		String taskName = TrafficForecastTask.creatUMTSSuppreReductionTask(driver, defaultWindowID, taskName001,
				groupFlage, groupType, groupFile1, cfgFile, pefFile, chrFile, pefU2000File, pefPRSFile, terminalFile1,
				HolidayFile, ModifyPara, PredictionDate, SuppreType, TcpUsage, DcmUser, HsdpaAve);
