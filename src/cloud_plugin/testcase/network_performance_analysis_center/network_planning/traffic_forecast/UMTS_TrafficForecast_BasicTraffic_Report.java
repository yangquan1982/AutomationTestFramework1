...
public class UMTS_TrafficForecast_BasicTraffic_Report {
	@Rule
	...
	public UMTS_TrafficForecast_BasicTraffic_Report(String secns, String TestCaseId, String taskName001,
			...
			String PredictionDate, String IndicType, boolean CalcFlage) {
		this.secns = secns;
