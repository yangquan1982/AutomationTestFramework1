...
public class UMTS_HotSpotSpeed_Para_Report {
	@Rule
	...
	private static String ParaFile = FilePath + "\\参数化表\\速率.xlsx";
	...
	public UMTS_HotSpotSpeed_Para_Report(String secns, String TestCaseId, String taskName001, String[] cfgFile,
			String[] EparaFile, String[] MrFile, String[] PfmFile, String[] NodeBPfmFile, String[] FeatureFile,
			String[] MapFile, String PositType, String RasterValue, boolean AGPSFlage, String RasterRateEvaType,
			String MRCount, String StartTime, String EndTime, String LowRate, String MainCellMR, boolean ClusterFlage,
