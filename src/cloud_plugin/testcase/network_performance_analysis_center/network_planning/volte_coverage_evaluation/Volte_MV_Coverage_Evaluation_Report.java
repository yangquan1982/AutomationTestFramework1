...
public class Volte_MV_Coverage_Evaluation_Report {
	@Rule
	...
	private String PredictionDataFile;
	...
	public Volte_MV_Coverage_Evaluation_Report(String secns, String TestCaseId, String taskName001, String RAT,
			String FallbackPolicy, String[] TaskType, String evaluateReport, String[] LTEsigFile, String[] LTEPPFile,
			String[] LTEpropertyFile, String LTEPrfFile, String PrfFile, String TrafficFile, String PredictionDataFile,
			...
			String ComplexLevel, String[] RSRP, boolean AllFlage, boolean RateFlage, boolean RedirectionFlage,
			boolean CQIFlage, boolean UserCountFlage, boolean PerfFlowFlage, boolean SrvccFlage) {
		this.secns = secns;
		...
		this.PredictionDataFile = PredictionDataFile;
	...
	public static Collection<Object[]> data() throws Exception {
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "MV"));
	}
	...
	public void G_Coverage_Evaluation() {
		...
		String PrfFile1 = null;
		if (PrfFile != null) {
			PrfFile1 = FilePath + PrfFile;
		}
		String TrafficFile1 = null;
		if (TrafficFile != null) {
			TrafficFile1 = FilePath + TrafficFile;
		}
		String PredictionDataFile1 = null;
		if (PredictionDataFile != null) {
			PredictionDataFile1 = FilePath + PredictionDataFile;
		}
		String taskName = VolteCoverageEvaluationTask.creatMVVolteCoverageEvaluationTask(driver, defaultWindowID,
				taskName001, RAT, FallbackPolicy, TaskType, evaluateReport, LTEsigFile, LTEPPFile, LTEpropertyFile,
				LTEPrfFile1, PrfFile1, TrafficFile1, PredictionDataFile1, mapFile, polygonFile, PositType, RasterValue,
