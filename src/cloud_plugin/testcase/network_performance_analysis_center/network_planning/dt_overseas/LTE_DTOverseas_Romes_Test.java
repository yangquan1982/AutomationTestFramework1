...
public class LTE_DTOverseas_Romes_Test {
	@Rule
	...
	@Test(GT3Kid = "")
	public void T001_LTE_CreatRomesTask() {
		System.out.println(ZIP.NowTime() + "Start the testcase:" + name.getMethodName());
		String taskName = AutoDTDataOverseasTask.creatRomesTask(driver, defaultWindowID, DTfile, EParafile, Mapfile,
