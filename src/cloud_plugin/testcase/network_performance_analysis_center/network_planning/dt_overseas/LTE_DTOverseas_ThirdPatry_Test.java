...
public class LTE_DTOverseas_ThirdPatry_Test {
	@Rule
	...
	@Test(GT3Kid = "")
	public void T001_LTE_CreatThirdPatryTask_Tems() {
		System.out.println(ZIP.NowTime() + "Start the testcase:" + name.getMethodName());
		String taskName = AutoDTDataOverseasTask.creatThirdPatryTask(driver, defaultWindowID, "Tems", DTfile, EParafile,
	...
	@Test(GT3Kid = "")
	public void T002_LTE_CreatThirdPatryTask_Nemo() {
		System.out.println(ZIP.NowTime() + "Start the testcase:" + name.getMethodName());
		String taskName = AutoDTDataOverseasTask.creatThirdPatryTask(driver, defaultWindowID, "Nemo", DTfile, EParafile,
				Mapfile, ExEParafile, Ratefile);
		TaskReportTask.asserTaskInitialState(driver, taskName, "");
		System.out.println(ZIP.NowTime() + "End the testcase:" + name.getMethodName());
	}
