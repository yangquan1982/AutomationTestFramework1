...
public class UMTS_Compare_SameNetElement_Test {
	...
	private static String ServiceType = "Comparison_of_UMTS_Multi_sector_Parameter";
	private static String FilePath = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\配置参数对比核查\\参数化表\\配置参数对比核查.xlsx";
	private static String FilePath1 = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\配置参数对比核查\\附件";
	...
	public UMTS_Compare_SameNetElement_Test(String secns, String TestCaseId, String taskName,
			String[] oldConfigFileName, String[] newConfigFileName,
			// 专家求助
	...
	public static Collection<Object[]> data() throws Exception {
		return Arrays.asList(ParamUtil.getObjectArr(FilePath, "对比_UMTS同网元配置对比1"));
	}
	...
	public void test() {
		...
		String taskName_str = Compare_Configuration_Parameters_Task.creatUMTSSameNetElement(driver, taskName,
				oldConfigFileName, newConfigFileName, defaultWindowID);
