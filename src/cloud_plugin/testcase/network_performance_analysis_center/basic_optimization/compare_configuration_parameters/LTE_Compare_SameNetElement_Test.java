...
public class LTE_Compare_SameNetElement_Test {
	@Rule
	...
	public LTE_Compare_SameNetElement_Test(String secns, String TestCaseId, String taskName, String[] oldConfigFileName,
	...
	public static Collection<Object[]> data() throws Exception {
		return Arrays.asList(ParamUtil.getObjectArr(FilePath, "对比_LTE_同网元配置"));
	}
	...
	public void test() {
		...
		String taskName_str = Compare_Configuration_Parameters_Task.creatLTESameNetElement(driver, taskName,
