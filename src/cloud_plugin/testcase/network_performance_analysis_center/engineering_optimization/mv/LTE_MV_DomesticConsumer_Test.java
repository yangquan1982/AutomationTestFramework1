...
public class LTE_MV_DomesticConsumer_Test {
	@Rule
	...
	private boolean ifDownloadMould;
	private boolean ideaFlage;
	private String grade;
	private String MVfilePath;
	private String sourceDownloadFileName;

	public LTE_MV_DomesticConsumer_Test(String secns, String testCaseId, String taskName, String detail,
			boolean ifDownloadMould, boolean ideaFlage, String grade, String mVfilePath,
			String sourceDownloadFileName) {
		this.secns = secns;
		this.TestCaseId = testCaseId;
		this.taskName = taskName;
		this.detail = detail;
		this.ifDownloadMould = ifDownloadMould;
		this.ideaFlage = ideaFlage;
		this.grade = grade;
		this.MVfilePath = mVfilePath;
		this.sourceDownloadFileName = sourceDownloadFileName;
	}

	@Parameters()
	public static Collection<Object[]> data() throws Exception {
		return Arrays.asList(ParamUtil.getObjectArr(ParaFile, "MVDomesticConsumer"));
	}
	...
	public void test() {
		...
		AutoMVDataTask.domesticConsumerTask(driver, taskName, detail, ifDownloadMould, ideaFlage, grade, MVfilePath1,
