...
public class LTE_MVExpert_Test {
	...
	private String downLoadSourceFileName;

	public LTE_MVExpert_Test(String secns, String testCaseId, String taskName, String detail, boolean ifDownLoadFile,
			boolean ideaFlage, String mVfilePath, String downLoadSourceFileName) {
		this.secns = secns;
		...
		this.downLoadSourceFileName = downLoadSourceFileName;

	}

	@Parameters()
	public static Collection<Object[]> data() throws Exception {
		return Arrays.asList(ParamUtil.getObjectArr(ParaFile, "MVExpert"));
	}
	...
	public void test() {
		...
		AutoMVDataTask.expertTask(driver, taskName, MVfilePath1, ideaFlage, detail, ifDownLoadFile,
