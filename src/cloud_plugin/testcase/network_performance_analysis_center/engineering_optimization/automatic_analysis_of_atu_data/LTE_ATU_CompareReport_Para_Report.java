...
public class LTE_ATU_CompareReport_Para_Report {
	...
	public LTE_ATU_CompareReport_Para_Report(String secns, String TestCaseId, String taskName001, String compareType,
			String[] cfgfile, String[] EParafile, String[] DTfile, String[] cfgfile2, String[] EParafile2,
			String[] DTfile2, String OperRSRP, String TextRSRP, String OperSINR, String TextSINR, String OperAPPUL,
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(ParamUtil.getObjectArr(ParaFile, "对比报告参数"));
	}
	...
	public void L_CompareReport() {
		...
		String taskName = AutoATUDataTask.creatCompareReportTask(driver, defaultWindowID, taskName001, compareType,
				cfgfile, EParafile, DTfile, cfgfile2, EParafile2, DTfile2, OperRSRP, TextRSRP, OperSINR, TextSINR,
