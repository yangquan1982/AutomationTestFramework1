...
public class LTE_ATU_ThemeOptimiz_Report {
	@Rule
	...
	public LTE_ATU_ThemeOptimiz_Report(String secns, String TestCaseId, String taskName001, String[] cfgfile,
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(ParamUtil.getObjectArr(ParaFile, "专题优化"));
	}
	...
	public void L_ThemeOptimiz() {
		...
		String taskName = AutoATUDataTask.creatThemeOptimizTask(driver, defaultWindowID, taskName001, cfgfile,
				EParafile, DTfile);
