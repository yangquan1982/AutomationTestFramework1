...
public class SingSite_Expert_Test {
	 ...
	 * @param filepath
	 */
	public SingSite_Expert_Test(String TestCaseId, String taskName, String ProcType, String detailedDescription,
			String Filepath) {
		super();
	...
	public void test() {
		...
		TaskViewPluginTask.expertProc(driver, taskName, ProcType, detailedDescription, filePath);
		result = true;
	}
