...
public class LTE_DT_DTOptimiz_Report {
	...
	public void L_DTOptimiz() {
		...
		String taskName = AutoDTDataTask.creatDTOptimizTask(driver, defaultWindowID, taskName001, WhetherTopN, TopN,
				WhetherGrids, GridsPre, GridsLater, WhetherPoint, TextRSRP, TextSINR, TextPDCPUL, TextPDCPDL, cfgfile,
				EParafile, DTfile);
