...
public class LTE_DT_CompareReport_Report {
	...
	public void L_CompareReport() {
		...
		String taskName = AutoDTDataTask.creatCompareReportTask(driver, defaultWindowID, taskName001, WhetherGrids,
				GridsPre, GridsLater, TextRSRP, TextSINR, TextPDCPUL, TextPDCPDL, cfgfile, EParafile, DTfile, cfgfile2,
				EParafile2, DTfile2);
