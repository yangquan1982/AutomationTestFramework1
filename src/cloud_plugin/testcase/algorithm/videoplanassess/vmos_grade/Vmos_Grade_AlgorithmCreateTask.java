...
public class Vmos_Grade_AlgorithmCreateTask {
	
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = ConstUrl.getProjectHomePath()+"\\Data\\baseline\\02_算法\\参数化\\视频规划与评估\\vMOS评分前台参数化表.xlsx";
	...
	public Vmos_Grade_AlgorithmCreateTask(String secns, String testId,String projectName,
