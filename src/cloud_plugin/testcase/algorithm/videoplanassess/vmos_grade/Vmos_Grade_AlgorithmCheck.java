package cloud_plugin.testcase.algorithm.videoplanassess.vmos_grade;
...
public class Vmos_Grade_AlgorithmCheck {
	
	private static WebDriver driver = null;
	private static String defaultWindowID = null;
	private boolean result = false;
//	private static String GT3KFile = FilePath + "\\GT3K.ini";
	private static String path = System.getProperty("user.dir")+"\\Data\\baseline\\02_算法\\参数化\\视频规划与评估\\vMOS评分算法参数化表.xlsx";
	...
	public Vmos_Grade_AlgorithmCheck(String testID,String taskName,String mark,String[] indexKey,
...
//		Log.info("用例场景是："+testName);
		...
		Algorithm.startCheck(driver,defaultWindowID,taskName,mark,indexKey,indexValue,expectKey,expectValue,compareFilePath,"Vmos_Grade");
		result = true;
	}
