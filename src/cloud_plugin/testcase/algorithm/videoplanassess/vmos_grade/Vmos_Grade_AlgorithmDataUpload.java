...
public class Vmos_Grade_AlgorithmDataUpload {

	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = SystemConstant.AlgorithmUploadParamAlgirithm+"vMOS评分前台参数化表.xlsx";
	...
	public Vmos_Grade_AlgorithmDataUpload(String scene,String rAT, String dataType, 
