...
public class Delimit_Location_AlgorithmDataUpload {

	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = SystemConstant.AlgorithmUploadParamAlgirithm+"定界定位前台参数化表.xlsx";
	...
	public Delimit_Location_AlgorithmDataUpload(String scene,String rAT, String dataType, 
