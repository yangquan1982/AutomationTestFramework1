package cloud_plugin.testcase.algorithm.videoplanassess.delimit_location;
...
public class Delimit_Location_AlgorithmCheck {
	
	private static WebDriver driver = null;
	private static String defaultWindowID = null;
	private boolean result = false;
//	private static String GT3KFile = FilePath + "\\GT3K.ini";
	private static String path = System.getProperty("user.dir")+"\\Data\\baseline\\02_算法\\参数化\\视频规划与评估\\定界定位算法参数化表.xlsx";
	...
	public Delimit_Location_AlgorithmCheck(String testID,String taskName,String mark,String[] indexKey,
...
//		Log.info("用例场景是："+testName);
		...
		Algorithm.startCheck(driver,defaultWindowID,taskName,mark,indexKey,indexValue,expectKey,expectValue,compareFilePath,"Delimit_Location");
		result = true;
	}
