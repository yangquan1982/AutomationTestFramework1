...
public class Delimit_Location_AlgorithmCreateTask {
	
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = ConstUrl.getProjectHomePath()+"\\Data\\baseline\\02_算法\\参数化\\视频规划与评估\\定界定位前台参数化表.xlsx";
	...
	public Delimit_Location_AlgorithmCreateTask(String secns, String testId,String projectName,
