...
public class Traffic_statistic_analysis_AlgorithmCheck {
	
	private static WebDriver driver = null;
	private static String defaultWindowID = null;
	private boolean result = false;
//	private static String GT3KFile = FilePath + "\\GT3K.ini";
	private static String path = System.getProperty("user.dir")+"\\Data\\baseline\\02_算法\\参数化\\视频规划与评估\\话统数据解析算法参数化表.xlsx";
	...
	public Traffic_statistic_analysis_AlgorithmCheck(String testID,String taskName,String mark,String[] indexKey,
	...
	{
		Collection<Object[]> coll = Arrays.asList(ParamUtil.getObjectArr(path, "算法正确性",16,3,0));
		return coll;
	}
...
//		Log.info("用例场景是："+testName);
		...
		Algorithm.startCheck(driver,defaultWindowID,taskName,mark,indexKey,indexValue,expectKey,expectValue,compareFilePath,"Volumen_Estimate");
		result = true;
	}
