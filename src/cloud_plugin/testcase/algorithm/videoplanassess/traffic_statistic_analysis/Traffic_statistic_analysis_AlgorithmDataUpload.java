...
public class Traffic_statistic_analysis_AlgorithmDataUpload {

	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = SystemConstant.AlgorithmUploadParamAlgirithm + "话统数据解析前台参数化表.xlsx";
	...
	public Traffic_statistic_analysis_AlgorithmDataUpload(String scene, String rAT, String dataType, String subDataType,
