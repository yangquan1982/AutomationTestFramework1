package cloud_plugin.testcase.algorithm.videoplanassess.traffic_statistic_analysis;
...
public class Traffic_statistic_analysis_AlgorithmCreateTask {

	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = ConstUrl.getProjectHomePath()
			+ "\\Data\\baseline\\02_算法\\参数化\\视频规划与评估\\话统数据解析前台参数化表.xlsx";
	...
	public Traffic_statistic_analysis_AlgorithmCreateTask(String secns, String testId, String projectName,
			String[] taskType, String[] cfgData, String[] paramData, String[] sigData,
			String[] nonEncryptedVideoSourceData, String[] encryptedVideoSourceData, String[] oTTData,
			String[] electronicMapData, String[] lTECharacteristicLibraryData, String[] performanceData,
			String videoTrafficForecastResultFile, String[] xDR_MRPreprocessData, String[] cDRData, String[] uELogsData,
			String[] dataPreprocessingSetItems, String[] dataPreprocessingSetValues, String[] evaluationSetItems,
			String[] evaluationSetItemsValues, String isIndependentBusyhourKPIs, String filteringMode,
			String busyhourKPI, String[] customHours, String busyDays, String legendSetItem,
			String legendSetSegmentNumber, String[] legendSetValue) {
		this.secns = secns;
		TestCaseId = testId;
	...
	public void T00_Algorithm_vMOSCreateTask() {
		SeqVMOSTask.ParamCreateTask(driver, secns, ProjectName, TaskType, CfgData, ParamData, SigData,
				NonEncryptedVideoSourceData, EncryptedVideoSourceData, OTTData, ElectronicMapData,
				LTECharacteristicLibraryData, PerformanceData, VideoTrafficForecastResultFile, XDR_MRPreprocessData,
				CDRData, UELogsData, DataPreprocessingSetItems, DataPreprocessingSetValues, EvaluationSetItems,
				EvaluationSetItemsValues, IsIndependentBusyhourKPIs, FilteringMode, BusyhourKPI, CustomHours, BusyDays,
				LegendSetItem, LegendSetSegmentNumber, LegendSetValue, IndexPage.AlgorithmProject);
	}
