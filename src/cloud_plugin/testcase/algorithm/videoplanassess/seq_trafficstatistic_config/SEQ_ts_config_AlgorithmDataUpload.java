...
public class SEQ_ts_config_AlgorithmDataUpload {

	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = SystemConstant.AlgorithmUploadParamAlgirithm + "SEQ与话统、配置、工参关联前台参数化表.xlsx";
	...
	public SEQ_ts_config_AlgorithmDataUpload(String scene, String rAT, String dataType, String subDataType,
