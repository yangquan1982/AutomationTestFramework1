package cloud_plugin.testcase.algorithm.videoplanassess.seq_trafficstatistic_config;
...
public class SEQ_ts_config_AlgorithmCreateTask {
	
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = ConstUrl.getProjectHomePath()+"\\Data\\baseline\\02_算法\\参数化\\视频规划与评估\\SEQ与话统、配置、工参关联前台参数化表.xlsx";
	...
	public SEQ_ts_config_AlgorithmCreateTask(String secns, String testId,String projectName,
	...
	public static void setUpBeforeClass() {
		Algorithm.deleteTempFile("D:\\Algorithm");
...
//		StartBackFillTMSS.backFill(TestCaseId,result);
		String taskID = SeqVMOSTask.getTaskIdFilterWithName(driver, ProjectName);
		Algorithm.WriteTaskID("Vmos_Grade",ProjectName,taskID);
	...
	public void T00_Algorithm_vMOSCreateTask() {	
		SeqVMOSTask.ParamCreateTask(driver, secns, ProjectName, TaskType,
				...
				LegendSetValue,IndexPage.AlgorithmProject);
