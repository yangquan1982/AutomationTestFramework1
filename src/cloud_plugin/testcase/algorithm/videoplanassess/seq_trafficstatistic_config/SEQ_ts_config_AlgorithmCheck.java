...
public class SEQ_ts_config_AlgorithmCheck {
	
	private static WebDriver driver = null;
	private static String defaultWindowID = null;
	private boolean result = false;
//	private static String GT3KFile = FilePath + "\\GT3K.ini";
	private static String path = System.getProperty("user.dir")+"\\Data\\baseline\\02_算法\\参数化\\视频规划与评估\\SEQ与话统、配置、工参关联算法参数化表.xlsx";
	...
	public SEQ_ts_config_AlgorithmCheck(String testID,String taskName,String mark,String[] indexKey,
...
//		Log.info("用例场景是："+testName);
		...
		Algorithm.startCheck(driver,defaultWindowID,taskName,mark,indexKey,indexValue,expectKey,expectValue,compareFilePath,"SEQ_ts_config");
		result = true;
	}
