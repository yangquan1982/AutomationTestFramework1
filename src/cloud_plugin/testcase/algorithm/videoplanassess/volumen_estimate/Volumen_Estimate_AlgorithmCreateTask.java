package cloud_plugin.testcase.algorithm.videoplanassess.volumen_estimate;
...
public class Volumen_Estimate_AlgorithmCreateTask {
	...
	private static String ParaFile = ConstUrl.getProjectHomePath()
			+ "\\Data\\baseline\\02_算法\\参数化\\视频规划与评估\\容量评估前台参数化表.xlsx";
	...
	public Volumen_Estimate_AlgorithmCreateTask(String secns, String testId, String projectName, String[] taskType,
