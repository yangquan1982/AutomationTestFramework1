...
public class SEQ_Related_AlgorithmCreateTask {
	
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = ConstUrl.getProjectHomePath()+"\\Data\\baseline\\02_算法\\参数化\\视频规划与评估\\SEQ话单关联前台参数化表.xlsx";
	...
	public SEQ_Related_AlgorithmCreateTask(String secns, String testId,String projectName,
