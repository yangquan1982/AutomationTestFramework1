...
public class SEQ_Related_AlgorithmDataUpload {

	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = SystemConstant.AlgorithmUploadParamAlgirithm+"SEQ话单关联前台参数化表.xlsx";
	...
	public SEQ_Related_AlgorithmDataUpload(String scene,String rAT, String dataType, 
