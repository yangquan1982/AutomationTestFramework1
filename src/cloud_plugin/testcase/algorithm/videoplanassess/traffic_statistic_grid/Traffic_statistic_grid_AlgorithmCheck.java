...
public class Traffic_statistic_grid_AlgorithmCheck {
	
	private static WebDriver driver = null;
	private static String defaultWindowID = null;
	private boolean result = false;
//	private static String GT3KFile = FilePath + "\\GT3K.ini";
	private static String path = System.getProperty("user.dir")+"\\Data\\baseline\\02_算法\\参数化\\视频规划与评估\\话统栅格化算法参数化表.xlsx";
	...
	public Traffic_statistic_grid_AlgorithmCheck(String testID,String taskName,String mark,String[] indexKey,
