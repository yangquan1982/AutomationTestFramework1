...
public class TEST_LTE_RF_Optimiz_Test {
	...
	public TEST_LTE_RF_Optimiz_Test(String secns, String ReportMode, String DateMode, String[] ThemeType,
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(ParamUtil.getObjectArr(ParaFile, "RF报告"));
	}
	...
	@Test(GT3Kid = "")
	public void RFReport_ThemeOptimiz() {
		// String DateMode = "gen";
		LOG.info_testcase("场景描述:" + secns);

		System.out.println(ZIP.NowTime() + "Start the testcase:" + name.getMethodName());
		String taskName = AutoPADataTask.creatRFThemeOptimizTask(driver, defaultWindowID, DateMode, ThemeType, cfgfile,
				EParafile, Datefile, secns);
