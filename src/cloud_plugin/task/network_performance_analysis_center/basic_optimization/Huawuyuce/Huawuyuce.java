...
public class Huawuyuce {
	...
	public static void downLoad_report(WebDriver driver, String defaultWindowID, String taskname, String ResultHome) {
		...
		String reportName = TaskViewPluginTask.waittingDownLoadFile(EnvConstant.Path_DownLoad, "LTE目标网预测报告");
		...
		ZIP.depress(EnvConstant.Path_DownLoad + "\\" + "LTEReport.zip", ResultHome);
	}
