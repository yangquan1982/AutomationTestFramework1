package cloud_plugin.task.network_performance_analysis_center.configuration_parameter_check;
...
public class CfgParameterCheckTask {
	...
	public static String downLoad_report(WebDriver driver, String defaultWindowID, String taskname) {
		...
		CommonJQ.click(driver, ".col6 a", true, "报告下载按钮");
