package cloud_platform.testcase.uploadabnormaldata.gsm;
...
public class T41_GSM_Equipment_ErrorFormat_01 {
	
	private static boolean result = false;
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = SystemConstant.UpLoadParamError+"GSM_ErrorFormatData_ParamTable.xlsx";
	private static String SheetName = "GSM_Equip_ErrorFormat_01";
	...
	public T41_GSM_Equipment_ErrorFormat_01(String scene, String testCaseId,
	...
	@Test(GT3Kid = "")
	public void T41_UpLoadDataErrorFormat_Vertify() {	
		LOG.info_testcase("场景描述:"+Scene);			
		DataCenterTask.abNormalIntegratedPacketSourceUpLoad(driver, RAT, DataType, SubDataType,Feature,DataPath,ErrorInfor);
		// 设置TMSS回填结果		
		result = true;
	}	
