package cloud_platform.testcase.uploadabnormaldata.tds;
...
public class T31_TDS_Data_0KB {

	private static boolean result = false;
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = SystemConstant.UpLoadParam0KB + "TDS_UpLoad_0KB_.xlsx";
	private static String SheetName = "TDS_0KB";
	...
	public T31_TDS_Data_0KB(String scene, String testCaseId, String rAT, String dataType, String subDataType,
			String feature, String[] dataPath, String errorInfor) {
		super();
		Scene = scene;
