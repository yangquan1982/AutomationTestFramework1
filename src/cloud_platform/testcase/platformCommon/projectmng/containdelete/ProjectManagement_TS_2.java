...
public class ProjectManagement_TS_2 {
	/*
	...
	String projectNameLabel = "网络规划自动化项目";
	String projectName = "中国浙江绍兴电信LTE网络规划自动化项目";
	String region = "中国区";
	String agent = "中国浙江";
	String operator = "绍兴电信";
	String rat = "LTE";
