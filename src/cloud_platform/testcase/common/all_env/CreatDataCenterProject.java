...
public class CreatDataCenterProject {

	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	
	private static boolean isDelete = false;// 存在项目时是否删除项目
	private static String ParaFile = ConstUrl.getProjectHomePath()+ "\\Data\\全量环境\\DataCenterProject.xlsx";//参数化表路径
//	private static String ParaFile = SystemConstant.UpLoadProjectParam;//参数化表路径
	...
	public CreatDataCenterProject(String secns, String type, String region,
