package cloud_platform.testcase.common.all_env_en;
...
public class All_NotDelExpert_Test {
	...
	private static String ParaFile = FilePath + "\\添加专家参数化表_EN.xlsx";

	public All_NotDelExpert_Test(String secns, String userName, String region, String agent, String[] operator,
			String[] rat) {
		this.secns = secns;
	...
	@Test(GT3Kid = "")
	public void addExpert_NotDel() {
		LOG.info_testcase("场景描述:" + secns);
		SystemManageTask.addExpert(driver, false, userName, region, agent, rat, operator);
	}
}
