...
public class T50_GSM_EngineeringParameter_TemplateDownLoad {

	private static boolean result = false;
	private static WebDriver driver = null;
	private static String defaultWindowID = null;
	private static String ParaFile = SystemConstant.UpLoadEngParamTable + "EngineeringParameterData_GSM.xlsx";
	...
	public T50_GSM_EngineeringParameter_TemplateDownLoad(String secns, String testCaseId, String templateName,
	...
	public static Collection<Object[]> data() throws Exception {
		Collection<Object[]> coll = Arrays.asList(ParamUtil.getObjectArr(ParaFile, "GSM"));
		return coll;
	}
