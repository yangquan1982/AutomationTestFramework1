...
public class T50_UMTS_EngineeringParameter_TemplateDownLoad {

	private static boolean result = false;
	private static WebDriver driver = null;
	private static String defaultWindowID = null;
	private static String ParaFile = SystemConstant.UpLoadEngParamTable + "EngineeringParameterData_UMTS.xlsx";
	...
	public T50_UMTS_EngineeringParameter_TemplateDownLoad(String secns, String testCaseId, String templateName,
	...
	public static Collection<Object[]> data() throws Exception {
		Collection<Object[]> coll = Arrays.asList(ParamUtil.getObjectArr(ParaFile, "UMTS"));
		return coll;
	}
