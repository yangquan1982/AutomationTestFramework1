...
public class LTE_UpLoad_CellNameIsNull {
	...
	private static String ParaFile = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\LTE_Topn小区处理\\参数化表\\"
			+ "LTE_Topn数据上传.xlsx";
	private static String SheetName = "cell名称为空";
	...
	public LTE_UpLoad_CellNameIsNull(String scene, String rAT, String dataType, String subDataType, String feature,
