...
public class LTE_TopnCellProcessing_UpLoad_NoIndex {
	
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = ConstUrl.getProjectHomePath()
			+ "\\Data\\baseline\\LTE_Topn小区处理\\参数化表\\"+"LTE_Topn数据上传.xlsx";
	private static String SheetName = "话统数据没有掉线指标";
	...
	public LTE_TopnCellProcessing_UpLoad_NoIndex(String scene, 
...
DataCenterTask.dataSourceUpLoadUseCustomFolder(driver, RAT, DataType, SubDataType,Feature,DataPath,Filename,projectName);
	}
