...
public class LTE_TopnCellProcessing_UpLoad_Zonghedata {
	...
	private static String ParaFile = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\LTE_Topn小区处理\\参数化表\\"
			+ "LTE_Topn数据上传.xlsx";
	private static String SheetName = "LTE综合数据包";
	...
	public LTE_TopnCellProcessing_UpLoad_Zonghedata(String scene, String rAT, String dataType, String subDataType,
