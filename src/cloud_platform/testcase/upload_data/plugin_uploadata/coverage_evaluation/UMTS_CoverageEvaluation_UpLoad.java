package cloud_platform.testcase.upload_data.plugin_uploadata.coverage_evaluation;
...
public class UMTS_CoverageEvaluation_UpLoad {
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String FilePath = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\U_覆盖评估";
	private static String ParaFile = FilePath + "\\参数化表\\覆盖评估数据上传.xlsx";
	...
	public UMTS_CoverageEvaluation_UpLoad(String scene, String rAT, String dataType, String subDataType, String feature,
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "数据"));
	}
