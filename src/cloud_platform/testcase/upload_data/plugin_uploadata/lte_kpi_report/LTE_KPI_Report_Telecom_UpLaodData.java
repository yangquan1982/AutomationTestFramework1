package cloud_platform.testcase.upload_data.plugin_uploadata.lte_kpi_report;
...
public class LTE_KPI_Report_Telecom_UpLaodData {

	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String FilePath = ConstUrl.getProjectHomePath()
			+ "\\Data\\baseline\\LTE KPI报告";
	private static String ParaFile = FilePath + "\\参数化表\\KPI报告数据上传.xlsx";

	private String projectName = IndexPage.LTE_Telecom;
	...
	public LTE_KPI_Report_Telecom_UpLaodData(String scene, String rAT,
