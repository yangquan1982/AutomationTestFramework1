package cloud_platform.testcase.upload_data.plugin_uploadata.pci_optimization;
...
public class LTE_PCIOptimization_UpLoad {
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String FilePath = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\PCI优化";
	private static String ParaFile = FilePath + "\\参数化表\\PCI优化数据上传.xlsx";
	...
	public LTE_PCIOptimization_UpLoad(String scene, String rAT, String dataType, String subDataType, String feature,
	...
	public static Collection<Object[]> data() throws Exception {
		Collection<Object[]> coll = Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "施恩"));
		return coll;
	}
