package cloud_platform.testcase.upload_data.plugin_uploadata.lteupinterfere_updata;
...
public class lteupinterfere_UpLoad {
	...
	public lteupinterfere_UpLoad(String scene, String rAT, String dataType, String subDataType, String feature,
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "射频数据上传"));
	}
