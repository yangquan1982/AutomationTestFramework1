package cloud_platform.testcase.upload_data.plugin_uploadata.three_dimensional_network_evaluation;
...
public class ThreeDNetWorkEva_UpLoadData {
	...
	public ThreeDNetWorkEva_UpLoadData(String scene, String RAT, String dataType, String subDataType, String feature,
	...
	public static Collection<Object[]> data() throws Exception {
		Collection<Object[]> coll = Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "数据上传"));
		return coll;
	}
