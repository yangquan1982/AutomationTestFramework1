package cloud_platform.testcase.upload_data.plugin_uploadata.poorqualitythresholdIdentification;
...
public class PoorQualityThresholdIdentificationUpLoad {
	private static WebDriver driver = null;
	private static String defaultWindowID = null;
	private static String FilePath = ConstUrl.getProjectHomePath()
			+ "\\Data\\baseline\\视频优化质差门限识别";
	private static String ParaFile = FilePath
			+ "\\参数化表\\质差门限识别_评估前台参数化表.xlsx";
	...
	public PoorQualityThresholdIdentificationUpLoad(String Scene, String RAT, String DataType,
