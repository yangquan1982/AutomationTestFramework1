...
public class LTE_Compare_SameElement_UploadData {
	 ...
	 * @param filename
	 */
	public LTE_Compare_SameElement_UploadData(String Scene, String RAT, String DataType, String SubDataType,
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "LTE同网元配置"));
	}
