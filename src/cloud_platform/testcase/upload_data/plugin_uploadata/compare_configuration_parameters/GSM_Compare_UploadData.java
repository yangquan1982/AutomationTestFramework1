...
public class GSM_Compare_UploadData {
	 ...
	 * @param filename
	 */
	public GSM_Compare_UploadData(String Scene, String RAT, String DataType, String SubDataType, String Feature,
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "GSM对比"));
	}
