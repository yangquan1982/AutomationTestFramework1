...
import cloud_platform.task.upload_data.CompareConfigurationParametersUploadDataTask;
...
public class CompareConfigurationParameters_UploadData {
	 ...
	 * @param filename
	 */
	public CompareConfigurationParameters_UploadData(String Scene, String RAT, String DataType, String SubDataType,
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "配置参数核查与对比数据上传"));
	}
	...
	public void test() {
		...
		CompareConfigurationParametersUploadDataTask.dataSourceUpLoadUseCustomFolder(driver, RAT, DataType, SubDataType,
				Feature, DataPath, Filename, projectName);
	}
