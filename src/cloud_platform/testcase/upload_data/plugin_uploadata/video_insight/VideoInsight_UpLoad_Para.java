package cloud_platform.testcase.upload_data.plugin_uploadata.video_insight;
...
public class VideoInsight_UpLoad_Para {
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String FilePath = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\视频洞察";
	private static String ParaFile = FilePath + "\\参数化表\\视频洞察数据上传.xlsx";
	...
	public VideoInsight_UpLoad_Para(String scene, String rAT, String dataType, String subDataType, String feature,
