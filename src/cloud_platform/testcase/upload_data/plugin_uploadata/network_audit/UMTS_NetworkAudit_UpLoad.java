package cloud_platform.testcase.upload_data.plugin_uploadata.network_audit;
...
public class UMTS_NetworkAudit_UpLoad {

	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String FilePath = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\网络评估\\UMTS";
	private static String ParaFile = FilePath + "\\参数化表\\网络评估数据上传.xlsx";
	...
	public UMTS_NetworkAudit_UpLoad(String scene, String rAT, String dataType, String subDataType, String feature,
	...
	public static Collection<Object[]> data() throws Exception {
		...
		return Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "数据上传"));
	}
