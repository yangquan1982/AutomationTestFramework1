...
public class LTE_NetworkAudit_UpLoad {
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String FilePath = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\网络评估\\LTE";
	private static String ParaFile = FilePath + "\\参数化表\\网络评估.xlsx";
	...
	public LTE_NetworkAudit_UpLoad(String scene, String rAT, String dataType, String subDataType, String feature,
