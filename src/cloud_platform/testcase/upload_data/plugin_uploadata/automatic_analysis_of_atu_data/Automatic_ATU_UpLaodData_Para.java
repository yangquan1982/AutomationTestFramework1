package cloud_platform.testcase.upload_data.plugin_uploadata.automatic_analysis_of_atu_data;
...
public class Automatic_ATU_UpLaodData_Para {
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String FilePath = ConstUrl.getProjectHomePath()
			+ "\\Data\\baseline\\ATU数据自动分析";
	private static String ParaFile = FilePath + "\\参数化表\\ATU数据上传.xlsx";
	...
	public Automatic_ATU_UpLaodData_Para(String scene, String rAT,
