package cloud_platform.testcase.upload_data.plugin_uploadata.volte_coverage_evaluation;
...
public class Volte_Coverage_Evaluation_UpLaod_Para {
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String FilePath = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\VoLTE覆盖评估";
	private static String ParaFile = FilePath + "\\参数化表\\VoLTE覆盖评估数据上传.xlsx";
	...
	public Volte_Coverage_Evaluation_UpLaod_Para(String scene, String rAT, String dataType, String subDataType,
	...
	public static Collection<Object[]> data() throws Exception {
		Collection<Object[]> coll = Arrays.asList(AppParamUtil.getObjectArr(ParaFile, "工参"));
		return coll;
	}
