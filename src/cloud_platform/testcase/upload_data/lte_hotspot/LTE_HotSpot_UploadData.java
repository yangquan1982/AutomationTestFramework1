package cloud_platform.testcase.upload_data.lte_hotspot;
...
public class LTE_HotSpot_UploadData {

	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\LTE_价值区域评估\\参数化表\\"
			+ "LTE_价值区域评估数据上传.xlsx";
	private static String SheetName = "科威特正确性";
	...
	public LTE_HotSpot_UploadData(String scene, String rAT, String dataType, String subDataType, String feature,
