package cloud_platform.testcase.upload_data.network_planning.rankupplan;
...
public class LTE_RankUpPlan_UpLoadData {
	private static boolean result = false;
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\L_Rankupplan\\参数化表\\"
			+ "排名提升规划.xlsx";
	private static String SheetName = "数据上传";
	private String projectName = IndexPage.LTE_Mobile;
	private static String GT3KFile = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\L_Rankupplan\\GT3K.ini";
	...
	public LTE_RankUpPlan_UpLoadData(String scene, String testCaseId, String rAT, String dataType, String subDataType,
