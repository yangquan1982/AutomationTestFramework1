...
public class T06_GSM_UpLoadGuide_Equip {

	private static boolean result = false;
	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = SystemConstant.UpLoadParam + "GSM_UpLoadGuide_ParamTable.xlsx";
	private static String SheetName = "GSM_Equip_Guide";
	...
	public T06_GSM_UpLoadGuide_Equip(String scene, String testCaseId, String rAT, String dataType, String subDataType) {
		super();
		Scene = scene;
	...
	@Test(GT3Kid = "")
	public void T01_GSM_UpLoad_Guide() {
		LOG.info_testcase("场景描述:" + Scene);
		DataCenterTask.IntegratedPacketUploadGuide(driver, RAT, DataType, SubDataType);
		// 设置TMSS回填结果
		result = true;
	}
