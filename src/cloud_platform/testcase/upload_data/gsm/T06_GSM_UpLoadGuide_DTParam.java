...
public class T06_GSM_UpLoadGuide_DTParam {
	...
	private static String SheetName = "GSM_DTParam_Guide";
	...
	public T06_GSM_UpLoadGuide_DTParam(String scene, String testCaseId, String rAT, String dataType,
			String subDataType) {
		super();
		Scene = scene;
