package cloud_platform.testcase.upload_data.umtsconfcompare;
...
public class UMTS_ConfCompare_UpLoadData {

	private static WebDriver driver = null;
	private static String defaultWindowID = null;

	private static String ParaFile = ConstUrl.getProjectHomePath() + "\\Data\\baseline\\UMTS配置参数对比\\参数化表\\"
			+ "UMTS配置参数对比数据上传.xlsx";
	private static String SheetName = "UMTSConfCompare";
	...
	public UMTS_ConfCompare_UpLoadData(String scene, String rAT, String dataType, String subDataType, String feature,
