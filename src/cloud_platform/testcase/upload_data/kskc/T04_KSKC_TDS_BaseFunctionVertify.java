...
public class T04_KSKC_TDS_BaseFunctionVertify {
	...
	public T04_KSKC_TDS_BaseFunctionVertify(String secns, String PrjName, String rat, String DataType,
	...
	@Test(GT3Kid = "")
	public void T001_TDS_KSKCVertify() {
	 ...
	 */
	@Test(GT3Kid = "")
	public void T002_TDS_KSKCVertify() {
		LOG.info_testcase("场景描述:" + secns);
		if (StringUtils.isBlank(PartNeName)) {
			PartNeName = null;
		}
