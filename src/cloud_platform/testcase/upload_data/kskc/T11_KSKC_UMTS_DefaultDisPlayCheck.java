...
public class T11_KSKC_UMTS_DefaultDisPlayCheck {
	...
	public T11_KSKC_UMTS_DefaultDisPlayCheck(String secns, String PrjName, String rat, String DataType,
	...
	@Test(GT3Kid = "")
	public void T001_UMTS_KSKCDefaultDisPlayVertify() {
		...
		Task_KSKC.KSKC_DefaultDisplayCheck(driver, ProjectName, RAT, DataType, SubDataType, NeDate, NeNumber,
				PartNeName, NeName, NoDataNeName, SearchText, ImportPath, isNofindNeNum, mustfindNeNum);
	}
