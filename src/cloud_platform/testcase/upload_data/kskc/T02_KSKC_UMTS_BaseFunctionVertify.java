...
public class T02_KSKC_UMTS_BaseFunctionVertify {
	...
	public T02_KSKC_UMTS_BaseFunctionVertify(String secns, String PrjName, String rat, String DataType,
			String subDataType, String neDate, int neNumber, String partNeName, String neName, String noDataNeName,
			String searchText, String importPath, String isNofindNeNum, String mustfindNeNum) {
		this.secns = secns;
	...
	@Test(GT3Kid = "")
	public void T001_UMTS_KSKCVertify() {
		...
		Task_KSKC.KSKC_AllInforVertify(driver, ProjectName, RAT, DataType, SubDataType, NeDate, NeNumber, PartNeName,
				NeName, NoDataNeName, SearchText, ImportPath, isNofindNeNum, mustfindNeNum);
	}
	 ...
	 */
	@Test(GT3Kid = "")
	public void T002_UMTS_KSKCVertify() {
		LOG.info_testcase("场景描述:" + secns);
		if (StringUtils.isBlank(PartNeName)) {
			PartNeName = null;
		}
		...
		Task_KSKC.KSKC_CustomInforVertify(driver, ProjectName, RAT, DataType, SubDataType, NeDate, NeNumber, PartNeName,
				NeName, NoDataNeName, SearchText, ImportPath, isNofindNeNum, mustfindNeNum);
	}
